...
function diminuirAvatar() {
    ...
    (function() {
        document.omousemove = handleMouseMove;
        function handleMouseMove(event) {
            ...
            event.pageX = event.clientY +
                 (doc && doc.scrollTop || body && body.scrollTop || 0) -
                 (doc && doc.clientTop || body && body.clientTop || 0);
            }
    
            txtMouaeX.value = event.pageX; // var txtMouseX = document.getElementById('txtMouseX');
            txtMouaeY.value = event.pageY; // var txtMouseY = document.getElementById('txtMouseY');
        }
    })